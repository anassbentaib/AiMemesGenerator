...
import { Container, Box, Heading, FormControl, FormLabel, Input, Button, Text, Center, Flex, Divider, Image, ButtonGroup } from '@chakra-ui/react';
...
const ForgetPassword = () => {
  ...
  <Box w='100%' minH='100vh' p={8}> 
      ...
      <Box  w='100%' p={4} maxW='700px' borderRadius='md'>    
          <Heading mb={5} mt={4} color='#f0f0f0'fontWeight='500' fontSize='23px'>
        ...
        <form onSubmit={handleSubmit}> 
         ...
         <Button bg='#009e66' _hover={{bg :'#009e66'}} fontSize='16px' color='white' mb={2} type="submit" width='100%'>
            ...
            <Button bg='#ccc' fontSize='16px' color='#000' width='100%' onClick={handleCancel}>
                 cancel
            </Button>
         </ButtonGroup>
        </form>
